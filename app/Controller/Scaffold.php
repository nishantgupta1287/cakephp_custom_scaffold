 ...
 */
	public function __construct(Controller $controller, CakeRequest $request) {
		$this->controller = $controller;
		 /**************Custom code********************/
		 $this->displayFieldsList = (isset($controller->displayFieldsList) && is_array($controller->displayFieldsList))?$controller->displayFieldsList:null;
		 /*********************************************/
		...
		if(!empty($this->displayFieldsList))
			$scaffoldFields =  array_intersect(array_keys($this->ScaffoldModel->schema()),$this->displayFieldsList);
		else
 ...
 */
	protected function _scaffoldIndex($params) {
		if ($this->controller->beforeScaffold('index')) {
			...
			$this->controller->set("list_of_fields",$this->displayFieldsList);
 			$this->controller->render($this->request['action'], $this->layout);
